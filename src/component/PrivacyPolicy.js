                ...
                {[
                  {
                    term: "Company",
                    definition:
                      "(referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to DivineLiightt & Divine Crystals.",
                  },
                  {
                    term: "Device",
                    definition:
                  ...
                  },
                  {
                    term: "Service",
                    definition:
                      "refers to the advertisement, website, or application.",
                  },
                ].map((item, index) => (
                  <li key={index}>

...
import { Shield, AlertCircle, Mail, ChevronRight, Copyright } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 font-sans text-gray-800 bg-gradient-to-b from-purple-50 to-white">
      ...
      <header className="mb-10 text-center">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4 font-serif">Refund Policy</h1>
        ...
        <div className="flex items-start mb-8">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              We want you to feel comfortable about transacting business with us. Due to the nature of our business 
              and the accessibility of our products/services/courses immediately upon purchase, we maintain a 
              <span className="font-bold text-purple-600"> NO REFUND POLICY</span>.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start">
            ...
            <p className="text-gray-700">
              YOU CAN ALWAYS CHECK THE QUALITY OF THE WORK WITH OUR SAMPLES AND DECIDE TO PURCHASE OUR PRODUCT/SERVICE.
            </p>
          </div>
          ...
          <div className="flex items-start">
            ...
            <p className="text-gray-700">
              ...
              <a href="mailto:admin@psychicvisions.in" className="text-purple-600 hover:underline font-medium">
      ...
      <footer className="mt-8 pt-6 border-t border-purple-100 text-sm text-gray-600">
        <div className="flex items-center mb-4">
          ...
          <span>Copyright 2023 - The DivineLiightt & Divine Crystals. All rights reserved.</span>
        </div>
